...
void getY(int16_t *y, int16_t *y_low, int16_t *y_high){

	GPIO_ResetBits(GPIOB,GPIO_Pin_12);
	SPI2_TransRecieve(ADXL_READ);
	SPI2_TransRecieve(0x10);
	*y_low=SPI2_TransRecieve(0x00);
	*y_high=SPI2_TransRecieve(0x00);
	GPIO_SetBits(GPIOB,GPIO_Pin_12);
